...
<p>
	...
	<input type="text" name="_plance_plugin_portfolio_light[link]" value="<?php echo esc_attr( $args['link'] ); ?>" style="width: 100%">
</p>
<p>
	<label><?php esc_html_e( 'Position number', 'plance-portfolio-light' ); ?>:</label><br>
	<input type="text" name="_plance_plugin_portfolio_light[position]" value="<?php echo esc_attr( $args['position'] ); ?>" style="width: 100%">
</p>
<p>
